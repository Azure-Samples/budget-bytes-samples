...
| 3 | [Agentic RAG](https://github.com/yorek/azure-sql-db-ai-samples-search/tree/sql-server-2025?tab=readme-ov-file) | Davide Mauri | Agentic RAG for Everyone Using Azure SQL, OpenAI, and Web Apps | [🎥YouTube](https://youtu.be/X_eiufFu3xY?si=QlDNiRYPnCHCAMGa) | [Azure SQL Samples Search with AI](https://github.com/yorek/azure-sql-db-ai-samples-search/tree/sql-server-2025?tab=readme-ov-file) |
