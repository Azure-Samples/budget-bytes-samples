# Budget Bytes: SQL and AI on a Budget
...
| Session | Topic | Speaker(s) | Focus | Video | Sample |
|---------|-------|------------|-------|-------|--------|
...
| 1 | [Microsoft Foundry](https://github.com/Azure-Samples/azure-sql-inventory-tracker-app) | Jasmine Greenaway | Inventory Management with Microsoft Foundry| [🎥 Build an Inventory Manager for Free](https://www.youtube.com/watch?v=lHKL19uYo_8&list=PLlrxD0HtieHgMVW6fTmK6Hb6LF1iWi27R&index=3)| [Inventory Tracker App](https://github.com/Azure-Samples/azure-sql-inventory-tracker-app) |
| 2 | [Insurance AI Application](https://aka.ms/ContosoDentalClinic) | Arvind Shyamsundar & Amar Digamber Patil | AI-driven insurance scenarios | [🎥 Build a Web App for Under $10!](https://youtu.be/PamhXD0m4fs) | [Contoso Dental Clinic](https://aka.ms/ContosoDentalClinic)|
| 3 | [Azure SQL Samples Search with AI](https://github.com/yorek/azure-sql-db-ai-samples-search/tree/sql-server-2025?tab=readme-ov-file) | Davide Mauri | Agentic RAG | [🎥Agentic RAG for Everyone Using Azure SQL, OpenAI, and Web Apps ](https://youtu.be/X_eiufFu3xY?si=QlDNiRYPnCHCAMGa) | [Azure SQL Samples Search with AI](https://github.com/yorek/azure-sql-db-ai-samples-search/tree/sql-server-2025?tab=readme-ov-file) |
...
- [Microsoft Foundry Documentation](https://docs.microsoft.com/azure/ai-foundry/)
